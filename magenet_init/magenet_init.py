...
def projection(param, crane_point, Z_from_magenet, intrinsic, distortion):
...
def cost_function(param, crane_point, corner_point, Z_from_magenet):

    crane_point[:,2] = Z_from_magenet

    image_points = projection(param, crane_point, Z_from_magenet, intrinsic, distortion)
...
param = [0.0, 0.0, 0.0] # tx, ty, theta


result = least_squares(cost_function, param, args=(crane_point, corner_point, Z_from_magenet))
...
image_points = projection(result_translate_param, crane_point, Z_from_magenet, intrinsic, distortion)
